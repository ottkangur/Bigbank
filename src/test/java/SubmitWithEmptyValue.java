...
public class SubmitWithEmptyValue extends DriverInitializer {
    ...
    private void openPage(){
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter(System.getProperty("user.dir")+ File.separator+"reports"+File.separator+"TestResults_empty.html");
    ...
    @Test
    public void submitWithEmptyValue() {
        ExtentTest testReport = report.createTest("Report_empty");
        ...
        loanApplicationPage.periodField.setFieldValue(newValue);
